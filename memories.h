...
public:
    ...
    void record_special_element(uint16_t pos, uint8_t macro_number);
    void config(uint8_t *memories);
    uint16_t is_recording(void) const { return m_beginningOfChar; }
...
#define RECORD_SPECIAL_ELEMENT(pos, macro)   system_memories.record_special_element(pos, macro)
...
#define RECORD_SPECIAL_ELEMENT(pos, macro) ((void)macro,(void)pos)
#define MEMORIES_CONFIG(memories) ((void)memories)
#define MEMORY_RECORDING()                    (0)
